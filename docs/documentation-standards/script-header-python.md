...
Repository   : logmask-python-library
Author       : VintageDon (https://github.com/vintagedon/)
Created      : YYYY-MM-DD
Link         : https://github.com/radioastronomyio/logmask-python-library
...
Use Google-style docstrings for functions (project convention):
...
def validate_file(
    ...
    Args:
        ...
        strict: Enable strict validation mode. Default is False.
...
- Use `\b` word-boundary anchors on all regex patterns
